    ...
    <div className={`relative min-h-screen ${isDarkMode ? 'dark' : ''}`}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 relative z-10 pt-24">
        ...
        <div className="mb-8 animate-appear">
          <div
            className={`relative p-4 sm:p-6 md:p-8 rounded-2xl overflow-hidden ${
              isDarkMode
          ...
          >
            ...
            <div
              className={`absolute inset-0 bg-gradient-to-r from-purple-600/10 via-blue-600/10 to-purple-600/10 animate-gradient-shift ${
            ...
            <div className="relative z-10">
              ...
              <p
                className={`text-base sm:text-xl md:text-2xl font-medium ${isDarkMode ? 'text-gray-200' : 'text-gray-800'} mb-3`}
              >
                {t('chatbot.subtitle')}
              </p>
              {user && (
                <div
                  className={`inline-block px-6 py-2 rounded-full ${
                    isDarkMode
                      ...
                      : 'bg-purple-100 border border-purple-300/50'
        ...
        {/* Usage Tips */}
        <div
          className={`hidden sm:block mb-8 p-4 sm:p-5 md:p-7 rounded-2xl relative overflow-hidden ${
            isDarkMode
        ...
        {/* Footer Info */}
        <div
          className={`mt-8 text-center py-4 px-4 rounded-xl ${isDarkMode ? 'bg-gray-900/60' : 'bg-white/70'} backdrop-blur-sm`}
        >
