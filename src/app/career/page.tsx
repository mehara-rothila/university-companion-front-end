...
type ActiveTab =
  'dashboard' | 'jobs' | 'career-paths' | 'profile' | 'interview-prep' | 'networking';
    ...
    setTimeout(() => {
      ...
      const mockJobs: JobOpportunity[] = [
        {
          ...
          description:
            'Join our team to build scalable software solutions that impact billions of users worldwide.',
          requirements: [
            'Computer Science or related field',
            'Programming experience in Python/Java/C++',
        ...
        },
        {
          ...
          description:
            'Work with our data science team to analyze user behavior and improve recommendation algorithms.',
          requirements: [
        ...
        },
        {
          ...
          description:
            'Drive product initiatives that enhance the travel experience for millions of users.',
          requirements: [
        ...
        },
        {
          ...
          description:
            'Build beautiful and responsive user interfaces for our music streaming platform.',
      ...
      const mockCareerPaths: CareerPath[] = [
        {
          ...
          field: 'Technology',
          description:
            'Design and develop software applications, systems, and platforms to solve complex problems.',
        ...
        },
        {
          ...
          description:
            'Extract insights from data to drive business decisions and build predictive models.',
        ...
        },
        {
          ...
          description:
            'Drive product strategy and work with cross-functional teams to deliver user-centric solutions.',
      ...
      const mockNetworkingEvents: NetworkingEvent[] = [
        ...
        },
        {
          ...
          isVirtual: true,
          description:
            'Network with female professionals in technology and learn about career advancement.',
          attendeeCount: 150,
                ...
                >
                  ...
                  >
                    <path
                      ...
                      strokeWidth={2}
                      d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2-2v2m8 0V6a2 2 0 012 2v6M8 8v6a2 2 0 002 2h4a2 2 0 002-2V8"
                    />
                  </svg>
                  Career Services Hub
                </h1>
                ...
                >
                  <div
                    className={`text-3xl font-bold mb-2 ${
                      careerProfile.aiCareerScore >= 80
                        ? 'text-green-500'
                        : careerProfile.aiCareerScore >= 60
                          ? 'text-yellow-500'
                          : 'text-red-500'
                    }`}
                  >
                      ...
                      >
                        <div className="flex items-start justify-between mb-3">
                          ...
                          <div className="flex items-center space-x-2">
                            <span
                              className={`px-2 py-1 text-xs rounded-full font-medium ${getMatchColor(
                                job.matchScore || 0
                              )}`}
                            >
                  ...
                  <div className="space-y-3">
                    {careerPaths
                      ...
                      .map((path) => (
                        <div
                          key={path.id}
                          className={`p-3 rounded-lg cursor-pointer transition-colors duration-200 hover:opacity-80 ${
                        ...
                        >
                          ...
                          >
                            ${path.averageSalary.entry.toLocaleString()} - $
                            {path.averageSalary.senior.toLocaleString()}
                          </p>
                          <div className="flex items-center justify-between">
                            <span
                              className={`text-xs px-2 py-1 rounded-full font-medium ${getDemandColor(
                                path.demandLevel
                              )}`}
                            >
                  ...
                  <div className="flex space-x-4">
                    ...
                    <label className="flex items-center">
                      <input
                        ...
                        onChange={(e) =>
                          setJobFilters((prev) => ({ ...prev, remote: e.target.checked }))
                        }
