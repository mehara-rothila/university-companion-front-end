              ...
              <div className="flex items-center">
                ...
                <div className="relative group">
                  {profileImage ? (
                    <img
                      src={
                        profileImage.includes('amazonaws.com')
                  ...
                  <div
                    className={`w-16 h-16 bg-gradient-to-br from-purple-600 to-purple-500 rounded-full flex items-center justify-center text-white text-2xl font-bold ${profileImage ? 'hidden' : ''}`}
                  >
                ...
                <div className="ml-4">
                  <h1
                    className={`text-3xl font-bold ${isDarkMode ? 'text-gray-100' : 'text-gray-900'} mb-1`}
                  >
                    {userProfile.personalInfo.name}
                  </h1>
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <p className={`text-xs ${isDarkMode ? 'text-gray-400' : 'text-gray-500'} mt-1`}>
                      {t('profile.personal.studentIdNote')}
                    </p>
                  </div>
                  ...
                  <div>
                    <label
                      className={`block text-sm font-medium ${isDarkMode ? 'text-gray-300' : 'text-gray-700'} mb-2`}
                    >
                      {t('profile.personal.academicYear')}
                    </label>
                    <select
                      value={userProfile.personalInfo.academicYear}
                      onChange={(e) =>
                        handleProfileUpdate('personalInfo', 'academicYear', e.target.value)
                      }
                      disabled={!isEditing}
                      className={`w-full px-4 py-3 rounded-lg border transition-all duration-200 ${
                        isDarkMode
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleProfileUpdate('personalInfo', 'emergencyContact', e.target.value)
                    }
                    disabled={!isEditing}
                    className={`w-full px-4 py-3 rounded-lg border transition-all duration-200 ${
                      isDarkMode
            ...
            {activeTab === 'preferences' && (
              <div className="space-y-6">
                ...
                <div>
                  ...
                  >
                    {t('profile.preferences.notificationPreferences')}
                  </h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {Object.entries(userProfile.preferences.notifications).map(([key, value]) => (
                      <div key={key} className="flex items-center justify-between">
                        <label
                          className={`text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-700'} capitalize`}
                        >
                          {t(`profile.preferences.${key}`)}
                        </label>
                        <button
                          onClick={() =>
                            handleProfileUpdate('preferences', 'notifications', {
                ...
                <div>
                  <h3
                    className={`text-lg font-semibold ${isDarkMode ? 'text-gray-200' : 'text-gray-800'} mb-4`}
                  >
                    {t('profile.preferences.studyPreferences')}
                  </h3>
                ...
                <div>
                  <h3
                    className={`text-lg font-semibold ${isDarkMode ? 'text-gray-200' : 'text-gray-800'} mb-4`}
                  >
                    {t('profile.preferences.learningStyle')}
                  </h3>
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                    {[
                      ...
                      <button
                        key={style.key}
                        onClick={() =>
                          handleProfileUpdate('preferences', 'learningStyle', style.key)
                        }
                        className={`p-3 rounded-lg border-2 text-sm font-medium transition-all duration-200 ${
            ...
            {activeTab === 'privacy' && (
              <div className="space-y-6">
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    <label
                      className={`block text-sm font-medium ${isDarkMode ? 'text-gray-300' : 'text-gray-700'} mb-3`}
                    >
                    ...
                    {[
                      {
                        ...
                        desc: t('profile.privacy.dataSharingDesc'),
                      },
                      {
                        key: 'analyticsOptIn',
                        label: t('profile.privacy.analytics'),
                        desc: t('profile.privacy.analyticsDesc'),
                      },
                      {
                        key: 'locationTracking',
                        label: t('profile.privacy.locationTracking'),
                        desc: t('profile.privacy.locationTrackingDesc'),
                      },
                    ].map((setting) => (
                      <div
                        key={setting.key}
                        className={`p-4 rounded-lg ${isDarkMode ? 'bg-gray-700/50' : 'bg-gray-50'} border ${isDarkMode ? 'border-gray-600' : 'border-gray-200'}`}
                      >
                          ...
                          <button
                            onClick={() =>
                              handleProfileUpdate(
                                ...
                                setting.key,
                                !userProfile.privacy[
                                  setting.key as keyof typeof userProfile.privacy
                                ]
                              )
                            }
                            className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ml-4 ${
                              userProfile.privacy[setting.key as keyof typeof userProfile.privacy]
                                ? 'bg-purple-600'
                  ...
                  >
                    <h3
                      className={`text-lg font-semibold ${isDarkMode ? 'text-red-300' : 'text-red-800'} mb-4`}
                    >
                    ...
                    <div className="space-y-3">
                      <Link
                        href="/ai-ethics"
                        className={`inline-flex items-center text-sm ${isDarkMode ? 'text-red-400 hover:text-red-300' : 'text-red-700 hover:text-red-800'} transition-colors duration-200`}
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          className="h-4 w-4 mr-2"
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  {[
                    {
                      key: 'chatbot',
                      name: t('profile.aiFeatures.chatbot'),
                      desc: t('profile.aiFeatures.chatbotDesc'),
                    },
                    {
                      key: 'studySpaceRecommendations',
                      name: t('profile.aiFeatures.studySpaceRecs'),
                      desc: t('profile.aiFeatures.studySpaceRecsDesc'),
                    },
                    {
                      key: 'scheduleOptimization',
                      name: t('profile.aiFeatures.scheduleOptimization'),
                      desc: t('profile.aiFeatures.scheduleOptimizationDesc'),
                    },
                    {
                      key: 'wellnessCheckins',
                      name: t('profile.aiFeatures.wellnessCheckins'),
                      desc: t('profile.aiFeatures.wellnessCheckinsDesc'),
                    },
                    {
                      key: 'careerGuidance',
                      name: t('profile.aiFeatures.careerGuidance'),
                      desc: t('profile.aiFeatures.careerGuidanceDesc'),
                    },
                    {
                      key: 'smartNavigation',
                      name: t('profile.aiFeatures.smartNavigation'),
                      desc: t('profile.aiFeatures.smartNavigationDesc'),
                    },
                  ].map((feature) => (
                    <div
                      key={feature.key}
                        ...
                        <button
                          onClick={() =>
                            handleProfileUpdate(
                              'aiFeatures',
                              feature.key,
                              !userProfile.aiFeatures[
                                feature.key as keyof typeof userProfile.aiFeatures
                              ]
                            )
                          }
                          className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ml-4 ${
                ...
                {/* AI Ethics Link */}
                <div
                  className={`p-6 rounded-lg ${isDarkMode ? 'bg-blue-900/20 border border-blue-800' : 'bg-blue-50 border border-blue-200'}`}
                >
                  <h3
                    className={`text-lg font-semibold ${isDarkMode ? 'text-blue-300' : 'text-blue-800'} mb-3`}
                  >
                    {t('profile.aiFeatures.aiTransparency')}
                  </h3>
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  ...
                  >
                    ...
                    >
                      {t('profile.activity.totalLogins')}
                    </div>
                  </div>
                  ...
                  >
                    <div className="text-2xl font-bold text-green-600 dark:text-green-400">
                      {activityStats.studySessionsBooked}
                    </div>
                    <div className={`text-sm ${isDarkMode ? 'text-green-300' : 'text-green-700'}`}>
                      {t('profile.activity.studySessions')}
                    </div>
                  </div>
                  ...
                  >
                    <div className="text-2xl font-bold text-blue-600 dark:text-blue-400">
                      {activityStats.wellnessCheckins}
                    </div>
                    <div className={`text-sm ${isDarkMode ? 'text-blue-300' : 'text-blue-700'}`}>
                      {t('profile.activity.wellnessCheckins')}
                    </div>
                  </div>
                  ...
                  >
                    <div className="text-2xl font-bold text-orange-600 dark:text-orange-400">
                      {activityStats.aiInteractions}
                    </div>
                    <div
                      className={`text-sm ${isDarkMode ? 'text-orange-300' : 'text-orange-700'}`}
                    >
                      {t('profile.activity.aiInteractions')}
                    </div>
                  </div>
                </div>
                ...
                >
                  <h3
                    className={`font-medium ${isDarkMode ? 'text-gray-200' : 'text-gray-800'} mb-2`}
                  >
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            ...
            >
              <div className="text-center">
                ...
                <h2
                  className={`text-xl font-bold ${isDarkMode ? 'text-gray-100' : 'text-gray-900'} mb-4`}
                >
