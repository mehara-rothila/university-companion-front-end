          ...
          schedule: [
            {
              ...
              startTime: '10:00',
              endTime: '11:00',
              location: 'IT Faculty - Lecture Hall A',
              type: 'lecture',
            },
            {
              day: 'Wednesday',
          ...
          schedule: [
            {
              ...
              startTime: '14:00',
              endTime: '15:00',
              location: 'IT Faculty - Lecture Hall B',
              type: 'lecture',
            },
            {
              day: 'Thursday',
            ...
            },
            {
              ...
              startTime: '10:00',
              endTime: '12:00',
              location: 'IT Faculty - Database Lab',
              type: 'lab',
            },
          ],
        },
          ...
          schedule: [
            {
              ...
              startTime: '08:00',
              endTime: '09:00',
              location: 'IT Faculty - Lecture Hall C',
              type: 'lecture',
            },
            {
              day: 'Wednesday',
            ...
            },
            {
              ...
              startTime: '10:00',
              endTime: '12:00',
              location: 'IT Faculty - Network Lab',
              type: 'lab',
            },
          ],
        },
          ...
          schedule: [
            {
              ...
              startTime: '10:00',
              endTime: '11:00',
              location: 'IT Faculty - Lecture Hall D',
              type: 'lecture',
            },
            {
              day: 'Thursday',
      ...
      const recommendations: AIRecommendation[] = [
        {
          ...
          description:
            'AI detected that you&apos;re most productive 2-4 PM. Schedule CS project work during this window.',
          priority: 'high',
        ...
        },
        {
          ...
          description:
            'Schedule review sessions 2 days before each quiz based on your performance patterns.',
          priority: 'medium',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 relative z-10 pt-24">
          ...
          {activeTab === 'calendar' && (
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              {/* Today's Schedule */}
              <div
                className={`lg:col-span-2 ${isDarkMode ? 'bg-gray-800/90 border-gray-700' : 'bg-white/90 border-gray-100'} rounded-2xl shadow-lg p-6 border backdrop-blur-sm animate-fade-in`}
              >
                ...
                <div className="space-y-4">
                  {getTodayEvents().length > 0 ? (
                    getTodayEvents().map((event) => (
                      <div
                        key={event.id}
                        className={`p-4 rounded-lg border-l-4 ${getEventTypeColor(event.type)} ${isDarkMode ? 'bg-gray-700/50' : 'bg-gray-50'}`}
                      >
                        <div className="flex items-start justify-between">
                          <div className="flex-1">
                            <div className="flex items-center">
                              ...
                              {event.isAIGenerated && (
                                <span
                                  className={`ml-2 text-xs px-2 py-1 rounded-full ${isDarkMode ? 'bg-purple-900/30 text-purple-400' : 'bg-purple-100 text-purple-700'}`}
                                >
                                  AI
                                </span>
                              )}
                            ...
                            {event.location && (
                              <p
                                className={`text-sm ${isDarkMode ? 'text-gray-500' : 'text-gray-500'} mt-1`}
                              >
                                📍 {event.location}
                              </p>
                            )}
                            {event.description && (
                              <p
                                className={`text-sm ${isDarkMode ? 'text-gray-400' : 'text-gray-600'} mt-2`}
                              >
                                {event.description}
                              </p>
                            )}
                          ...
                          <div className="ml-4 flex flex-col items-end">
                            <span
                              className={`text-xs px-2 py-1 rounded-full capitalize ${getPriorityColor(event.priority)}`}
                            >
                              {event.priority}
                            </span>
                            {event.location && (
                    ...
                    .map((assignment) => (
                      ...
                      >
                        <div className="flex items-start justify-between mb-2">
                          <h4
                            className={`font-medium ${isDarkMode ? 'text-gray-100' : 'text-gray-900'} text-sm`}
                          >
                            {assignment.title}
                          </h4>
                          <span
                            className={`text-xs px-2 py-1 rounded-full capitalize ${getPriorityColor(assignment.priority)}`}
                          >
                            {assignment.priority}
                          </span>
                        </div>
                        ...
                        <p
                          className={`text-xs ${isDarkMode ? 'text-gray-400' : 'text-gray-600'} mb-2`}
                        >
                        ...
                        <div className="mb-2">
                          <div className={`w-full bg-gray-200 dark:bg-gray-600 rounded-full h-2`}>
                            <div
                              ...
                              style={{
                                width: `${(assignment.completedHours / assignment.estimatedHours) * 100}%`,
                              }}
                            ></div>
                          </div>
                          <p
                        ...
                        <span
                          className={`text-xs px-2 py-1 rounded-full capitalize ${getStatusColor(assignment.status)}`}
                        >
                    ...
                    >
                      <div className="flex items-start justify-between mb-3">
                        <div>
                          ...
                          >
                            {assignment.course} • {assignment.type} • Due{' '}
                      ...
                      <div className="mb-3">
                        ...
                        <div className={`w-full bg-gray-200 dark:bg-gray-600 rounded-full h-2`}>
                          <div
                            ...
                            style={{
                              width: `${Math.min((assignment.completedHours / assignment.estimatedHours) * 100, 100)}%`,
                            }}
                          ></div>
                        </div>
                      </div>
                      ...
                      {assignment.aiSuggestions && assignment.aiSuggestions.length > 0 && (
                        <div
                          className={`mt-3 p-3 rounded-lg ${isDarkMode ? 'bg-purple-900/20 border-purple-800' : 'bg-purple-50 border-purple-200'} border`}
                        >
                          <h5
                            className={`text-sm font-medium ${isDarkMode ? 'text-purple-300' : 'text-purple-800'} mb-2 flex items-center`}
                          >
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                ...
                <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                      {['high', 'medium', 'low'].map((priority) => {
                        const count = assignments.filter(
                          (a) => a.priority === priority && a.status !== 'completed'
                        ).length;
                        return (
                          <div key={priority} className="flex items-center justify-between">
                            <span
                              className={`text-sm capitalize ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}
                            >
                              {priority}
                            </span>
                            <span
                  ...
                  >
                    ...
                    <p className={`text-sm ${isDarkMode ? 'text-blue-400' : 'text-blue-700'}`}>
                      Based on your patterns, you&apos;re most productive from 2-4 PM. Consider
                      scheduling your CS project work during this time.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                  ...
                  <div>
                    ...
                    <div className="flex items-center">
                      ...
                      <div className="text-right">
                        <span
                          className={`text-sm px-2 py-1 rounded-full ${isDarkMode ? 'bg-green-900/30 text-green-400' : 'bg-green-100 text-green-700'}`}
                        >
                          ...
                          <div className="flex items-center justify-between mb-2">
                            ...
                            <span
                              className={`font-medium ${
                                course.currentGrade && course.currentGrade >= 90
                                  ? 'text-green-500'
                                  : course.currentGrade && course.currentGrade >= 80
                                    ? 'text-blue-500'
                                    : course.currentGrade && course.currentGrade >= 70
                                      ? 'text-yellow-500'
                                      : 'text-red-500'
                              }`}
                            >
              ...
              >
                ...
                <div className="space-y-6">
                  ...
                  >
                    <h4
                      className={`font-medium ${isDarkMode ? 'text-blue-300' : 'text-blue-800'} mb-3`}
                    >
