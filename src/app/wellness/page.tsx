...
export default function WellnessPage() {
  ...
  const [aiRecommendations] = useState<AIRecommendation[]>([
    {
      ...
      description:
        'AI detected elevated stress patterns. A 5-minute breathing exercise could help.',
      confidence: 89,
      urgency: 'medium',
    ...
    },
    {
      ...
      description:
        'Your sleep data suggests irregular patterns. Consider our sleep improvement guide.',
      confidence: 76,
      urgency: 'low',
  ...
  const getMoodColor = (mood: string) => {
    switch (mood) {
      ...
      case 'happy':
        return 'text-green-400 bg-green-100 dark:bg-green-900/30';
      case 'neutral':
  ...
  const calculateWellnessScore = () => {
    ...
    const avgSleep =
      recent.reduce((sum, entry) => sum + Math.min(entry.sleep / 8, 1) * 10, 0) / recent.length;
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 relative z-10 pt-24">
          ...
          <div className="mb-8 animate-fade-in">
            <div className="text-center">
              ...
              >
                AI-powered mental health support and wellness tracking to help you thrive
                ...
                {aiRecommendations.map((rec) => (
                  ...
                  >
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span
                        className={`text-xs px-2 py-1 rounded-full ${getUrgencyColor(rec.urgency)}`}
                      >
                        {rec.urgency}
                      </span>
                    </div>
                        ...
                        >
                          <div className="flex items-center justify-between mb-2">
                            <div className="flex items-center space-x-3">
                              ...
                              <div>
                                <span
                                  className={`text-sm font-medium px-2 py-1 rounded-full ${getMoodColor(entry.mood)}`}
                                >
                                  {entry.mood.replace('-', ' ')}
                                </span>
                              </div>
                          ...
                          <div className="grid grid-cols-3 gap-3 mb-3">
                            ...
                            <div className="text-center">
                              <div
                                className={`text-lg font-bold ${entry.stress > 7 ? 'text-red-500' : entry.stress > 4 ? 'text-yellow-500' : 'text-green-500'}`}
                              >
                                {entry.stress}/10
                              </div>
                              <div
                          ...
                          {entry.notes && (
                            <p
                              className={`text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-700'} italic`}
                            >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {wellnessResources.map((resource) => (
                    ...
                    >
                      ...
                      {resource.duration && (
                        <p
                          className={`text-sm ${isDarkMode ? 'text-blue-400' : 'text-blue-600'} mb-2`}
                        >
                          ⏱️ {resource.duration}
                        </p>
                      )}
        ...
        {showCheckInModal && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div
              className={`${isDarkMode ? 'bg-gray-800' : 'bg-white'} rounded-2xl shadow-xl max-w-md w-full p-6 max-h-[90vh] overflow-y-auto`}
            >
                        ...
                        {question.options?.map((option, optIndex) => (
                          <label key={optIndex} className="flex items-center">
                            ...
                            >
                              {option}{' '}
                              {question.id === '1' &&
                                getMoodEmoji(option.toLowerCase().replace(' ', '-'))}
                            </span>
                          </label>
                        ))}
                      </div>
            ...
            >
              <div className="text-center">
                ...
                <p className={`text-sm ${isDarkMode ? 'text-gray-400' : 'text-gray-600'} mb-6`}>
                  If you&rsquo;re experiencing a mental health crisis, please reach out for help
                  immediately. You&rsquo;re not alone.
                </p>
