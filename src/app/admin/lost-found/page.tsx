          ...
          <div className="mb-8">
            ...
            >
              ...
              <div className="flex items-center space-x-4">
                ...
                <div
                  className={`px-4 py-2 rounded-lg ${isDarkMode ? 'bg-purple-900/30 border border-purple-700/30' : 'bg-purple-100 border border-purple-200'}`}
                >
                  <p
                ...
                {items.map((item) => (
                  ...
                  >
                    ...
                    <div className="flex gap-4 mb-4">
                      ...
                      <div
                        className={`w-24 h-24 flex-shrink-0 rounded-lg overflow-hidden ${isDarkMode ? 'bg-gray-600' : 'bg-gray-200'}`}
                      >
                        {item.imageUrl ? (
                          <img
                        ...
                        <div
                          className={`${item.imageUrl ? 'hidden' : ''} w-full h-full flex items-center justify-center`}
                        >
                          <ImageIcon
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex flex-wrap gap-x-3 gap-y-1 text-xs">
                          ...
                          {item.reward && item.reward > 0 && (
                            <span
                              className={`flex items-center ${isDarkMode ? 'text-yellow-300' : 'text-yellow-700'}`}
                            >
                    ...
                    <div
                      className={`mt-auto pt-4 border-t ${isDarkMode ? 'border-gray-600' : 'border-gray-200'} flex gap-2 flex-wrap`}
                    >
                      {/* Edit Image button */}
                      <button
                        type="button"
