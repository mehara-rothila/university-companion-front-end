...
export const metadata: Metadata = {
  ...
  description:
    'Transform your university experience with Athena, your intelligent university companion. Get AI-powered assistance, smart navigation, study spaces, and seamless university integration designed for academic excellence.',
  keywords: [
