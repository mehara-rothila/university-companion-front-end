      ...
      const mockDiningHalls: DiningHall[] = [
        {
          ...
          predictedCrowd: [
            ...
            { time: '13:00', level: 'very-high' },
            { time: '14:00', level: 'medium' },
            { time: '18:00', level: 'high' },
            { time: '19:00', level: 'medium' }
          ],
          menuTypes: ['International', 'Comfort Food', 'Healthy Options'],
          specialties: ['Pizza', 'Salad Bar', 'Grill Station'],
          rating: 4.2,
          reviewCount: 1547,
          priceRange: '$$',
          features: ['All-you-can-eat', 'Meal plan accepted', 'Takeout available'],
          aiRecommended: true,
          walkTime: 3
        },
        {
