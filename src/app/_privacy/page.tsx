...
export default function DataPrivacyPage() {
  ...
  const [integrations, setIntegrations] = useState<ThirdPartyIntegration[]>([
    {
      ...
      permissions: [
        { id: '1', name: 'Read Calendar', description: 'View your calendar events', isGranted: true, isRequired: true, riskLevel: 'low' },
        { id: '2', name: 'Create Events', description: 'Add new events to your calendar', isGranted: true, isRequired: true, riskLevel: 'medium' },
        { id: '3', name: 'Edit Events', description: 'Modify existing calendar events', isGranted: false, isRequired: false, riskLevel: 'medium' }
      ],
      isActive: true,
    ...
    },
    {
      ...
      permissions: [
        { id: '4', name: 'Activity Data', description: 'Access your daily activity and exercise data', isGranted: true, isRequired: true, riskLevel: 'low' },
        { id: '5', name: 'Heart Rate', description: 'Read heart rate and health metrics', isGranted: true, isRequired: false, riskLevel: 'medium' },
        { id: '6', name: 'Sleep Data', description: 'Access sleep patterns and quality', isGranted: false, isRequired: false, riskLevel: 'medium' }
      ],
      isActive: false,
    ...
    },
    {
      ...
      permissions: [
        ...
        { id: '9', name: 'File Access', description: 'Access shared files in your teams', isGranted: true, isRequired: false, riskLevel: 'high' }
      ],
      isActive: true,
  ...
  const [dataInsights] = useState<DataInsight[]>([
    { category: 'Academic', totalSize: '2.3 MB', recordCount: 1247, lastActivity: new Date('2024-01-25'), growthRate: '+12%', retentionDays: 2555 },
    { category: 'Wellness', totalSize: '1.8 MB', recordCount: 892, lastActivity: new Date('2024-01-24'), growthRate: '+8%', retentionDays: 1095 },
    { category: 'Social', totalSize: '956 KB', recordCount: 356, lastActivity: new Date('2024-01-23'), growthRate: '+24%', retentionDays: 730 },
    { category: 'Financial', totalSize: '687 KB', recordCount: 234, lastActivity: new Date('2024-01-22'), growthRate: '+5%', retentionDays: 2555 },
    { category: 'Technical', totalSize: '445 KB', recordCount: 1890, lastActivity: new Date('2024-01-25'), growthRate: '+3%', retentionDays: 365 }
  ]);
      ...
      <>
        ...
        <main className={`min-h-screen ${isDarkMode ? 'bg-gradient-to-b from-gray-900 to-gray-800' : 'bg-gradient-to-b from-gray-50 to-gray-100'} transition-colors duration-300 flex items-center justify-center`}>
          <div className="text-center">
            ...
            <p className={`${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>Loading privacy settings...</p>
          </div>
        </main>
      </>
    );
      ...
      <main className={`min-h-screen ${isDarkMode ? 'bg-gradient-to-b from-gray-900 to-gray-800' : 'bg-gradient-to-b from-gray-50 to-gray-100'} transition-colors duration-300 relative overflow-hidden`}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 relative z-10 pt-24">
          ...
          <div className="mb-8 animate-fade-in">
            <div className="text-center">
              ...
              <p className={`text-xl ${isDarkMode ? 'text-gray-400' : 'text-gray-600'} max-w-3xl mx-auto mb-6`}>
                Complete control over your personal data with transparency, security, and compliance at every step.
              </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            <div className={`p-6 rounded-xl ${isDarkMode ? 'bg-blue-900/20 border border-blue-800' : 'bg-blue-50 border border-blue-200'} text-center animate-fade-in`}>
              ...
              <div className={`text-sm ${isDarkMode ? 'text-blue-300' : 'text-blue-700'}`}>Privacy Score</div>
            </div>
            ...
            <div className={`p-6 rounded-xl ${isDarkMode ? 'bg-green-900/20 border border-green-800' : 'bg-green-50 border border-green-200'} text-center animate-fade-in`}>
              ...
              <div className={`text-sm ${isDarkMode ? 'text-green-300' : 'text-green-700'}`}>Active Data Types</div>
            </div>
            ...
            <div className={`p-6 rounded-xl ${isDarkMode ? 'bg-purple-900/20 border border-purple-800' : 'bg-purple-50 border border-purple-200'} text-center animate-fade-in`}>
              ...
              <div className={`text-sm ${isDarkMode ? 'text-purple-300' : 'text-purple-700'}`}>Connected Apps</div>
            </div>
            ...
            <div className={`p-6 rounded-xl ${isDarkMode ? 'bg-orange-900/20 border border-orange-800' : 'bg-orange-50 border border-orange-200'} text-center animate-fade-in`}>
              ...
              <div className={`text-sm ${isDarkMode ? 'text-orange-300' : 'text-orange-700'}`}>Total Data Size</div>
            </div>
          </div>
          ...
          <div className={`mb-8 ${isDarkMode ? 'bg-green-900/20 border-green-800' : 'bg-green-50 border-green-200'} rounded-2xl p-6 border animate-fade-in`}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className={`p-4 rounded-lg ${isDarkMode ? 'bg-gray-800/50' : 'bg-white/50'} border ${isDarkMode ? 'border-gray-700' : 'border-gray-200'}`}>
                <h4 className={`font-medium ${isDarkMode ? 'text-gray-100' : 'text-gray-900'} mb-2`}>✅ Strong Protection</h4>
                <p className={`text-sm ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>
                  Your privacy settings provide robust protection for personal data
                </p>
              </div>
              <div className={`p-4 rounded-lg ${isDarkMode ? 'bg-gray-800/50' : 'bg-white/50'} border ${isDarkMode ? 'border-gray-700' : 'border-gray-200'}`}>
                <h4 className={`font-medium ${isDarkMode ? 'text-gray-100' : 'text-gray-900'} mb-2`}>🔒 Minimal Sharing</h4>
                <p className={`text-sm ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>
                  Data sharing is limited to essential services only
                </p>
              </div>
              <div className={`p-4 rounded-lg ${isDarkMode ? 'bg-gray-800/50' : 'bg-white/50'} border ${isDarkMode ? 'border-gray-700' : 'border-gray-200'}`}>
                <h4 className={`font-medium ${isDarkMode ? 'text-gray-100' : 'text-gray-900'} mb-2`}>⏰ Regular Cleanup</h4>
                <p className={`text-sm ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>
          ...
          <div className={`${isDarkMode ? 'bg-gray-800/90 border-gray-700' : 'bg-white/90 border-gray-100'} rounded-2xl shadow-lg border backdrop-blur-sm animate-fade-in`}>
                  ...
                  <div className={`p-6 rounded-xl ${isDarkMode ? 'bg-gray-700/50' : 'bg-gray-50'}`}>
                    ...
                    <div className="space-y-4">
                      {dataInsights.map((insight) => (
                        <div key={insight.category} className={`p-4 rounded-lg ${isDarkMode ? 'bg-gray-600/50' : 'bg-white'} border ${isDarkMode ? 'border-gray-600' : 'border-gray-200'}`}>
                          ...
                          <div className="grid grid-cols-3 gap-3 text-sm">
                            <div>
                              <span className={`${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>Records:</span>
                              <p className={`font-medium ${isDarkMode ? 'text-gray-200' : 'text-gray-800'}`}>
                                {insight.recordCount.toLocaleString()}
                              </p>
                            </div>
                            <div>
                              <span className={`${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>Growth:</span>
                              <p className={`font-medium ${insight.growthRate.startsWith('+') ? 'text-green-500' : 'text-red-500'}`}>
                                {insight.growthRate}
                              </p>
                            </div>
                            <div>
                              <span className={`${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>Retention:</span>
                              <p className={`font-medium ${isDarkMode ? 'text-gray-200' : 'text-gray-800'}`}>
              ...
              <div className="p-8">
                ...
                <div className="space-y-6">
                  {dataCategories.map((category) => (
                    <div key={category.id} className={`p-6 rounded-xl ${isDarkMode ? 'bg-gray-700/50 border border-gray-600' : 'bg-gray-50 border border-gray-200'}`}>
                        ...
                        <div className="ml-4">
                          <label className="relative inline-flex items-center cursor-pointer">
                            <input
                              ...
                              onChange={() => !category.isRequired && toggleDataCategory(category.id)}
                              disabled={category.isRequired}
                              className="sr-only peer"
                            />
                            <div className={`w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600 ${category.isRequired ? 'opacity-50 cursor-not-allowed' : ''}`}></div>
                          </label>
                        </div>
                      </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        ...
                        <div className="space-y-3">
                          <div>
                            <span className={`text-sm font-medium ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}>Purpose:</span>
                            <p className={`text-sm ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>{category.purpose}</p>
                          </div>
                          <div>
                            <span className={`text-sm font-medium ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}>Retention:</span>
                            <p className={`text-sm ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>{category.retention}</p>
                          </div>
                          <div>
                            <span className={`text-sm font-medium ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}>Data Size:</span>
                            <p className={`text-sm ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>{category.dataSize}</p>
                          </div>
                        </div>
                      </div>
            ...
            {activeTab === 'privacy-settings' && (
              <div className="p-8">
                ...
                {['Data Collection', 'Personalization', 'Communication', 'Sharing'].map((category) => (
                  <div key={category} className="mb-8">
                    ...
                    <div className="space-y-4">
                      {privacySettings.filter(setting => setting.category === category).map((setting) => (
                        <div key={setting.id} className={`p-4 rounded-lg ${isDarkMode ? 'bg-gray-700/50 border border-gray-600' : 'bg-gray-50 border border-gray-200'}`}>
                          <div className="flex items-start justify-between">
                            <div className="flex-1">
                              <h4 className={`font-medium ${isDarkMode ? 'text-gray-100' : 'text-gray-900'} mb-1`}>
                                {setting.name}
                              </h4>
                              <p className={`text-sm ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>
                                {setting.description}
                            ...
                            <div className="ml-4">
                              ...
                              {setting.type === 'select' && setting.options && (
                                <select
                                  ...
                                  onChange={(e) => updatePrivacySetting(setting.id, e.target.value)}
              ...
              <div className="p-8">
                ...
                <div className="space-y-4">
                  {dataRequests.map((request) => (
                    <div key={request.id} className={`p-6 rounded-xl ${isDarkMode ? 'bg-gray-700/50 border border-gray-600' : 'bg-gray-50 border border-gray-200'}`}>
                          ...
                          <div className="flex items-center space-x-3 mb-2">
                            <h3 className={`font-semibold ${isDarkMode ? 'text-gray-100' : 'text-gray-900'}`}>
                              {request.type === 'export' ? 'Data Export' : 
                               request.type === 'delete' ? 'Data Deletion' : 'Data Rectification'}
                            </h3>
                      ...
                      <div className="mb-4">
                        ...
                        <div className="flex flex-wrap gap-2">
                          {request.dataCategories.map(category => (
                            <span key={category} className={`px-2 py-1 text-xs rounded ${isDarkMode ? 'bg-gray-600 text-gray-300' : 'bg-gray-200 text-gray-600'}`}>
                              {category}
                            </span>
                          ))}
                        </div>
              ...
              <div className="p-8">
                ...
                <div className="space-y-6">
                  {integrations.map((integration) => (
                    <div key={integration.id} className={`p-6 rounded-xl ${isDarkMode ? 'bg-gray-700/50 border border-gray-600' : 'bg-gray-50 border border-gray-200'}`}>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        ...
                        <div className="space-y-2">
                          <div>
                            <span className={`text-sm font-medium ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}>Connected:</span>
                            <p className={`text-sm ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>
                              {integration.connectedDate.toLocaleDateString()}
                            </p>
                          </div>
                          <div>
                            <span className={`text-sm font-medium ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}>Last Access:</span>
                            <p className={`text-sm ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>
                      ...
                      <div className="mb-4">
                        ...
                        <div className="space-y-2">
                          {integration.permissions.map((permission) => (
                            <div key={permission.id} className={`flex items-center justify-between p-3 rounded ${isDarkMode ? 'bg-gray-600/50' : 'bg-white'}`}>
                              <div className="flex-1">
            ...
            {activeTab === 'audit' && (
              <div className="p-8">
                <div className="flex items-center justify-between mb-6">
                  ...
                  <div className="flex items-center space-x-4">
                    <div className={`text-3xl font-bold ${privacyAudit.score >= 90 ? 'text-green-500' : privacyAudit.score >= 70 ? 'text-yellow-500' : 'text-red-500'}`}>
                      {privacyAudit.score}%
                    </div>
                ...
                {/* Audit Summary */}
                <div className={`p-6 rounded-xl ${isDarkMode ? 'bg-gray-700/50 border border-gray-600' : 'bg-gray-50 border border-gray-200'} mb-6`}>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="text-center">
                    ...
                    <div className="text-center">
                      ...
                      <div className={`text-sm ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>Findings</div>
                    </div>
                    <div className="text-center">
                      <div className={`text-2xl font-bold ${isDarkMode ? 'text-purple-400' : 'text-purple-600'}`}>
                        {privacyAudit.type}
                      </div>
                      <div className={`text-sm ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>Audit Type</div>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  {privacyAudit.findings.map((finding) => (
                    <div key={finding.id} className={`p-6 rounded-xl ${isDarkMode ? 'bg-gray-700/50 border border-gray-600' : 'bg-gray-50 border border-gray-200'}`}>
                      ...
                      <div className={`p-3 rounded ${isDarkMode ? 'bg-blue-900/20' : 'bg-blue-50'}`}>
                        <h5 className={`text-sm font-medium ${isDarkMode ? 'text-blue-300' : 'text-blue-800'} mb-1`}>
                          Recommendation:
                        </h5>
        ...
        {showExportModal && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className={`${isDarkMode ? 'bg-gray-800' : 'bg-white'} rounded-2xl shadow-xl max-w-md w-full p-6`}>
              <div className="flex items-center justify-between mb-6">
                <h2 className={`text-xl font-bold ${isDarkMode ? 'text-gray-100' : 'text-gray-900'}`}>Export Your Data</h2>
                <button 
              ...
              <div className="text-center">
                ...
                <p className={`text-sm ${isDarkMode ? 'text-gray-400' : 'text-gray-600'} mb-6`}>
                  We&apos;ll prepare a complete export of your data in machine-readable format. You&apos;ll receive an email when it&apos;s ready.
                </p>
                ...
                <div className="space-y-3">
                  ...
                  <p className={`text-xs ${isDarkMode ? 'text-gray-500' : 'text-gray-500'}`}>
                    Export will include all data categories you have enabled. Processing typically takes 24-48 hours.
                  </p>
                </div>
              </div>
            </div>
        ...
        {showDeleteModal && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className={`${isDarkMode ? 'bg-gray-800' : 'bg-white'} rounded-2xl shadow-xl max-w-md w-full p-6`}>
              <div className="flex items-center justify-between mb-6">
                <h2 className={`text-xl font-bold ${isDarkMode ? 'text-gray-100' : 'text-gray-900'}`}>Delete Data</h2>
                <button 
              ...
              <div className="text-center">
                ...
                <p className={`text-sm ${isDarkMode ? 'text-gray-400' : 'text-gray-600'} mb-6`}>
                  ⚠️ This action cannot be undone. Some data may be retained for legal compliance requirements.
                </p>
