        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 relative z-10 pt-24">
          ...
          <div className="mb-8 animate-fade-in">
            ...
            >
              ...
              >
                Community platform to help reunite lost items with their owners. Post what
                you&apos;ve lost or found to connect with others on university.
              </p>
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className={`${isDarkMode ? 'text-blue-400' : 'text-blue-600'} text-sm mt-1`}>
                    You can view it in the "My Items" tab. It will be visible to others once
                    approved.
                  </p>
                </div>
              </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
            <div
              className={`p-4 rounded-lg ${isDarkMode ? 'bg-purple-900/20 border border-purple-800' : 'bg-purple-50 border border-purple-200'} animate-fade-in`}
            >
            ...
            <div
              className={`p-4 rounded-lg ${isDarkMode ? 'bg-orange-900/20 border border-orange-800' : 'bg-orange-50 border border-orange-200'} animate-fade-in`}
            >
                    ...
                    {filteredItems.map((item) => (
                      ...
                      >
                        ...
                        <div className="space-y-3">
                          ...
                          <p
                            className={`text-sm ${isDarkMode ? 'text-gray-400' : 'text-gray-600'} line-clamp-3`}
                          >
                            {item.description}
                          </p>
              ...
              <div className="p-8">
                ...
                {!loading && myItems.length === 0 && (
                  <div className="text-center py-12">
                    ...
                    <p
                      className={`text-sm ${isDarkMode ? 'text-gray-500' : 'text-gray-400'} mt-2 mb-4`}
                    >
                ...
                {!loading && myItems.length > 0 && (
                  <div className="space-y-4">
                    {myItems.map((item) => (
                      <div
                        key={item.id}
                        className={`p-6 rounded-lg ${isDarkMode ? 'bg-gray-700/50 border border-gray-600' : 'bg-gray-50 border border-gray-200'} transition-all duration-200`}
                      >
                            ...
                            <div className="flex items-start justify-between">
                              <div className="flex-1">
                                ...
                                <div className="flex items-center space-x-4 text-sm">
                                  ...
                                  {item.reward && (
                                    <span
                                      className={`${isDarkMode ? 'text-yellow-300' : 'text-yellow-700'}`}
                                    >
                                      💰 Rs {item.reward} reward
                                    </span>
                                  )}
                  ...
                  {[
                    {
                      ...
                      story:
                        "Lost my grandmother's wedding ring at the gym. Someone found it and posted here. We connected and I got it back the next day!",
                      user: 'Emily R.',
                      reward: 'Rs 100',
                      icon: '💍',
                    },
                    {
                      ...
                      story:
                        'Left my laptop in the library and panicked. Someone posted it here and I contacted them immediately. Got it back just in time!',
                      user: 'David K.',
                      reward: 'Rs 75',
                      icon: '💻',
                    },
                    {
                      ...
                      story:
                        'Dropped my car keys somewhere on university. Posted here and someone had already found them! Amazing community.',
                      user: 'Maria S.',
                      reward: 'Rs 25',
                      icon: '🗝️',
                    },
                    {
                      ...
                      story:
                        'Lost my bag with all my textbooks for finals. A kind student found it and posted here. Saved my semester!',
                      user: 'James L.',
                      reward: 'Rs 50',
                      icon: '📚',
                    },
                    ...
                    >
                      <div className="flex items-start space-x-4">
                        ...
                        <div className="flex-1">
                          ...
                          <p
                            className={`text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-700'} mb-4 italic`}
                          >
                            &quot;{story.story}&quot;
                          </p>
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setNewItemForm({
                          ...newItemForm,
                          reward: e.target.value ? parseFloat(e.target.value) : undefined,
                        })
                      }
                      placeholder="0"
                      min="0"
                    ...
                    <label className="flex items-center">
                      <input
                        ...
                        onChange={(e) =>
                          setNewItemForm({
                            ...newItemForm,
                            contactMethod: e.target.value as 'DIRECT' | 'ANONYMOUS',
                          })
                        }
                        className="mr-3"
                      />
