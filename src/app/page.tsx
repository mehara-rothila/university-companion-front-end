...
export default function Home() {
  ...
  const features = [
    ...
    },
    {
      ...
      title: t('home', 'smartNavigation'),
      description: t('home', 'smartNavigationDescription'),
      color: "from-blue-500 to-cyan-500"
    },
    {
      icon: <BookOpen className="h-8 w-8" />,
      title: t('home', 'studySpaces'),
      description: t('home', 'studySpacesDescription'),
      color: "from-cyan-500 to-teal-500"
    },
    {
      icon: <Search className="h-8 w-8" />,
      title: t('home', 'lostAndFound'),
      description: t('home', 'lostAndFoundDescription'),
  ...
  return (
    <>
      ...
      <div className={`min-h-screen ${isDarkMode ? 'bg-gradient-to-b from-gray-900 to-gray-800' : 'bg-gradient-to-b from-gray-50 to-gray-100'} transition-colors duration-300 relative overflow-hidden`}>
        ...
        {/* Hero Section */}
        <section className="relative pt-20" aria-label={t('home', 'heroSectionLabel')}>
            ...
            <div className="text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-16">
                {!isAuthenticated ? (
                  ...
                  >
                    {t('home', 'welcomeBackPrefix')} {user?.firstName}{t('home', 'welcomeBackSuffix')}
        ...
        {/* Quick Features Grid */}
        <section className="py-20" aria-label={t('home', 'featuresLabel')}>
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className={`text-lg ${isDarkMode ? 'text-gray-400' : 'text-gray-600'} max-w-2xl mx-auto`}>
                {t('home', 'everythingYouNeedDescription')}
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                {
                  icon: <Bot className="h-8 w-8" />,
                  title: t('home', 'aiChatAssistant'),
                  description: t('home', 'aiChatAssistantDescription'),
                  color: "from-purple-500/20 to-blue-500/20",
                  borderColor: "border-purple-400/30"
                },
                {
                  icon: <MapPin className="h-8 w-8" />,
                  title: t('home', 'interactiveMaps'),
                  description: t('home', 'interactiveMapsDescription'),
                  color: "from-blue-500/20 to-cyan-500/20",
                  borderColor: "border-blue-400/30"
                },
                {
                  icon: <BookOpen className="h-8 w-8" />,
                  title: t('home', 'studyResources'),
                  description: t('home', 'studyResourcesDescription'),
                  color: "from-cyan-500/20 to-teal-500/20",
                  borderColor: "border-cyan-400/30"
                },
                {
                  icon: <Search className="h-8 w-8" />,
                  title: t('home', 'lostFoundCard'),
                  description: t('home', 'lostFoundCardDescription'),
                  color: "from-teal-500/20 to-emerald-500/20",
                  borderColor: "border-teal-400/30"
                },
                {
                  icon: <Heart className="h-8 w-8" />,
                  title: t('home', 'wellnessHub'),
                  description: t('home', 'wellnessHubDescription'),
        ...
        {/* Stats Section */}
        <section className="py-20" aria-label={t('home', 'statsLabel')}>
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className={`glass-card backdrop-blur-lg border ${isDarkMode ? 'border-gray-700' : 'border-gray-200'} rounded-3xl p-12 shadow-2xl`}>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
                {[
                  { icon: <Star className="h-8 w-8" />, number: t('home', 'studentSatisfactionValue'), label: t('home', 'studentSatisfaction') },
                  { icon: <Shield className="h-8 w-8" />, number: t('home', 'aiAssistanceValue'), label: t('home', 'aiAssistance') },
                  { icon: <Zap className="h-8 w-8" />, number: t('home', 'responseTimeValue'), label: t('home', 'responseTime') }
                ].map((stat, index) => (
        ...
        {/* Footer CTA */}
        <section className="py-20" aria-label={t('home', 'ctaLabel')}>
