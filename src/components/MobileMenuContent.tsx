  ...
  return (
    <div className="p-4 space-y-2 border-t border-gray-100 dark:border-gray-700">
      ...
      <div className="space-y-1">
        <Link href="/" className="mobile-nav-link flex items-center py-2.5" onClick={closeMenu}>
      ...
      <div>
        ...
        >
          <span className="text-sm flex items-center">
            <GraduationCap className="h-4 w-4 mr-2 text-purple-600 dark:text-purple-400" /> Campus
            Features
          </span>
        ...
        {expandedSection === 'features' && (
          <div className="pl-3 space-y-1 mt-1">
            <Link
              href="/chatbot"
              className="mobile-nav-link flex items-center py-2"
              onClick={closeMenu}
            >
      ...
      <div>
        ...
        >
          <span className="text-sm flex items-center">
            <Library className="h-4 w-4 mr-2 text-purple-600 dark:text-purple-400" /> Resources &
            More
          </span>
      ...
      {isAuthenticated && user?.role === 'ADMIN' && (
        <>
          ...
          <Link
            href="/admin"
            className="mobile-nav-link flex items-center py-2.5 bg-purple-50 dark:bg-purple-900/30"
            onClick={closeMenu}
          >
