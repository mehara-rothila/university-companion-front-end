...
const NotificationToast: React.FC = () => {
  ...
  return (
    <div className="fixed top-20 right-4 z-50 space-y-3 max-w-sm">
      {/* WebSocket Connection Status - Only show on error */}
      {!isConnected && connectionError && (
        <div className="bg-red-500 border-l-4 border-red-700 text-white p-3 rounded-lg shadow-lg backdrop-blur-sm flex items-center space-x-3 transition-all duration-300">
