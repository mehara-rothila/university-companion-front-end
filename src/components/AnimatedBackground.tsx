    ...
    <>
      ...
      <style jsx global>{`
        ...
        @keyframes mesh-drift-2 {
          ...
          25% {
            transform: rotate(90deg) scale(1.2) translate(-30px, 10px);
          }
          50% {
            transform: rotate(180deg) scale(0.8) translate(10px, -30px);
          }
          75% {
        ...
        @keyframes mesh-drift-3 {
          ...
          50% {
            transform: rotate(180deg) scale(1.3) translate(-10px, 10px);
          }
        }
        ...
        @keyframes equation-float-1 {
          ...
          75% {
            transform: translateY(-25px) translateX(10px) rotate(7deg);
            opacity: 0.9;
          }
        }
        ...
        @keyframes equation-float-4 {
          ...
          40% {
            transform: translateY(-45px) translateX(-10px) rotate(-6deg);
            opacity: 0.7;
          }
          60% {
        ...
        @keyframes particle-drift-1 {
          ...
          25% {
            transform: translateY(-120px) translateX(80px) rotate(90deg);
            opacity: 0.9;
          }
          50% {
            transform: translateY(-80px) translateX(160px) rotate(180deg);
            opacity: 0.7;
          }
          75% {
            transform: translateY(-200px) translateX(40px) rotate(270deg);
            opacity: 1;
          }
        }
        ...
        @keyframes particle-drift-2 {
          ...
          33% {
            transform: translateY(-100px) translateX(-60px) rotate(120deg);
            opacity: 0.8;
          }
          66% {
            transform: translateY(-160px) translateX(120px) rotate(240deg);
            opacity: 0.6;
          }
        }
        ...
        @keyframes particle-drift-3 {
          ...
          50% {
            transform: translateY(-250px) translateX(-40px) rotate(180deg);
            opacity: 0.3;
          }
        }
        ...
        @keyframes particle-drift-4 {
          ...
          25% {
            transform: translateY(-80px) translateX(100px) rotate(90deg);
            opacity: 0.4;
          }
          75% {
            transform: translateY(-180px) translateX(-80px) rotate(270deg);
            opacity: 0.9;
          }
        }
        ...
        @keyframes glass-float-3 {
          ...
          20% {
            transform: translate(40px, -20px) rotate(72deg) scale(1.1);
          }
          40% {
            transform: translate(-30px, -40px) rotate(144deg) scale(0.9);
          }
          60% {
            transform: translate(-50px, 30px) rotate(216deg) scale(1.15);
          }
          80% {
        ...
        @keyframes bubble-drift-3 {
          ...
          50% {
            transform: translate(30px, 70px) scale(1.4);
            opacity: 0.3;
          }
        }
      ...
      >
        ...
        <div
          className={`absolute top-[33%] right-[17%] ${symbolColors[1]} text-8xl floating-icon-reverse`}
        >
          π
        </div>
        <div
          className={`absolute top-[61%] left-[27%] ${symbolColors[2]} text-8xl floating-icon-slow`}
        >
          ∞
        </div>
        <div className={`absolute top-[19%] right-[38%] ${symbolColors[3]} text-7xl floating-icon`}>
          ⚛
        </div>
        <div
          className={`absolute bottom-[31%] left-[8%] ${symbolColors[4]} text-8xl floating-icon-reverse`}
        >
          ∫
        </div>
        <div
          className={`absolute bottom-[12%] right-[42%] ${symbolColors[5]} text-9xl floating-icon`}
        >
          ≈
        </div>
        <div
          className={`absolute bottom-[47%] right-[9%] ${symbolColors[6]} text-8xl floating-icon-slow`}
        >
          ±
        </div>
        <div className={`absolute top-[23%] left-[54%] ${symbolColors[7]} text-8xl floating-icon`}>
          Δ
        </div>
        <div
          className={`absolute top-[44%] left-[38%] ${symbolColors[8]} text-7xl floating-icon-slow`}
        >
          λ
        </div>
        <div
          className={`absolute top-[81%] left-[67%] ${symbolColors[9]} text-9xl floating-icon-reverse`}
        >
          θ
        </div>
        <div className={`absolute top-[29%] left-[83%] ${symbolColors[10]} text-8xl floating-icon`}>
          α
        </div>
        <div
          className={`absolute bottom-[63%] left-[6%] ${symbolColors[11]} text-9xl floating-icon-slow`}
        >
          β
        </div>
        <div
          className={`absolute bottom-[19%] left-[71%] ${symbolColors[12]} text-8xl floating-icon-reverse`}
        >
          μ
        </div>
        <div
          className={`absolute bottom-[28%] left-[32%] ${symbolColors[13]} text-7xl floating-icon`}
        >
          ω
        </div>
        <div
          className={`absolute top-[52%] left-[18%] ${symbolColors[14]} text-8xl floating-icon-slow`}
        >
          γ
        </div>
        <div
          className={`absolute top-[37%] right-[29%] ${symbolColors[15]} text-9xl floating-icon`}
        >
          σ
        </div>
        <div
          className={`absolute bottom-[42%] right-[37%] ${symbolColors[0]} text-8xl floating-icon-reverse`}
        >
          δ
        </div>
        <div
          className={`absolute top-[73%] right-[13%] ${symbolColors[1]} text-8xl floating-icon-slow`}
        >
          ρ
        </div>
        ...
        <div
          className={`absolute top-[12%] left-[72%] ${symbolColors[2]} text-7xl floating-icon-reverse`}
        >
          ∇
        </div>
        <div
          className={`absolute bottom-[8%] left-[15%] ${symbolColors[3]} text-8xl floating-icon-slow`}
        >
          ∀
        </div>
        <div className={`absolute top-[47%] right-[4%] ${symbolColors[4]} text-7xl floating-icon`}>
          ∂
        </div>
        <div
          className={`absolute top-[65%] left-[3%] ${symbolColors[5]} text-8xl floating-icon-reverse`}
        >
          Φ
        </div>

        {/* More symbols for density */}
        <div className={`absolute top-[8%] left-[35%] ${symbolColors[6]} text-6xl floating-icon`}>
          Ψ
        </div>
        <div
          className={`absolute top-[88%] right-[25%] ${symbolColors[7]} text-7xl floating-icon-reverse`}
        >
          Ω
        </div>
        <div
          className={`absolute top-[15%] right-[58%] ${symbolColors[8]} text-6xl floating-icon-slow`}
        >
          ε
        </div>
        <div
          className={`absolute bottom-[85%] left-[58%] ${symbolColors[9]} text-8xl floating-icon`}
        >
          ζ
        </div>
        <div
          className={`absolute top-[78%] right-[48%] ${symbolColors[10]} text-7xl floating-icon-reverse`}
        >
          η
        </div>
        <div
          className={`absolute bottom-[25%] right-[78%] ${symbolColors[11]} text-6xl floating-icon-slow`}
        >
          κ
        </div>
        <div className={`absolute top-[35%] left-[88%] ${symbolColors[12]} text-8xl floating-icon`}>
          ι
        </div>
        <div
          className={`absolute bottom-[55%] left-[45%] ${symbolColors[13]} text-7xl floating-icon-reverse`}
        >
          ν
        </div>
        <div
          className={`absolute top-[68%] right-[68%] ${symbolColors[14]} text-6xl floating-icon-slow`}
        >
          ξ
        </div>
        <div
          className={`absolute bottom-[15%] right-[58%] ${symbolColors[15]} text-8xl floating-icon`}
        >
          χ
        </div>
        <div
          className={`absolute top-[28%] left-[8%] ${symbolColors[0]} text-7xl floating-icon-reverse`}
        >
          ψ
        </div>
        <div
          className={`absolute bottom-[68%] right-[8%] ${symbolColors[1]} text-6xl floating-icon-slow`}
        >
          τ
        </div>
        <div className={`absolute top-[58%] right-[28%] ${symbolColors[2]} text-8xl floating-icon`}>
          φ
        </div>
        <div
          className={`absolute bottom-[45%] left-[68%] ${symbolColors[3]} text-7xl floating-icon-reverse`}
        >
          υ
        </div>
        <div
          className={`absolute top-[92%] left-[78%] ${symbolColors[4]} text-6xl floating-icon-slow`}
        >
          ∃
        </div>
        <div className={`absolute top-[5%] right-[85%] ${symbolColors[5]} text-8xl floating-icon`}>
          ∈
        </div>
        <div
          className={`absolute bottom-[92%] right-[45%] ${symbolColors[6]} text-7xl floating-icon-reverse`}
        >
          ∉
        </div>
        <div
          className={`absolute top-[42%] left-[95%] ${symbolColors[7]} text-6xl floating-icon-slow`}
        >
          ⊂
        </div>
        <div
          className={`absolute bottom-[38%] left-[85%] ${symbolColors[8]} text-8xl floating-icon`}
        >
          ⊃
        </div>
        <div
          className={`absolute top-[85%] right-[78%] ${symbolColors[9]} text-7xl floating-icon-reverse`}
        >
          ⊆
        </div>
        <div
          className={`absolute bottom-[78%] left-[25%] ${symbolColors[10]} text-6xl floating-icon-slow`}
        >
          ⊇
        </div>
        <div
          className={`absolute top-[25%] right-[95%] ${symbolColors[11]} text-8xl floating-icon`}
        >
          ∪
        </div>
        <div
          className={`absolute bottom-[58%] right-[88%] ${symbolColors[12]} text-7xl floating-icon-reverse`}
        >
          ∩
        </div>
        <div
          className={`absolute top-[75%] left-[88%] ${symbolColors[13]} text-6xl floating-icon-slow`}
        >
          ∧
        </div>
        <div
          className={`absolute bottom-[28%] left-[78%] ${symbolColors[14]} text-8xl floating-icon`}
        >
          ∨
        </div>
        <div
          className={`absolute top-[48%] left-[75%] ${symbolColors[15]} text-7xl floating-icon-reverse`}
        >
          ¬
        </div>
        <div
          className={`absolute bottom-[48%] right-[75%] ${symbolColors[0]} text-6xl floating-icon-slow`}
        >
          ⇒
        </div>
        <div className={`absolute top-[18%] left-[48%] ${symbolColors[1]} text-8xl floating-icon`}>
          ⇔
        </div>
        <div
          className={`absolute bottom-[18%] right-[48%] ${symbolColors[2]} text-7xl floating-icon-reverse`}
        >
          ∴
        </div>
        <div
          className={`absolute top-[82%] left-[68%] ${symbolColors[3]} text-6xl floating-icon-slow`}
        >
          ∵
        </div>
        <div
          className={`absolute bottom-[82%] right-[68%] ${symbolColors[4]} text-8xl floating-icon`}
        >
          ⟨
        </div>
        <div
          className={`absolute top-[38%] left-[28%] ${symbolColors[5]} text-7xl floating-icon-reverse`}
        >
          ⟩
        </div>
        ...
        <div
          className={`absolute top-1/4 left-1/6 text-4xl font-bold ${equationColors[0]} animate-equation-float-1`}
        >
          ∫ e⁻ˣ² dx = √π/2
        </div>
        <div
          className={`absolute top-1/3 right-1/5 text-3xl font-bold ${equationColors[1]} animate-equation-float-2`}
        >
          ∑ 1/n² = π²/6
        </div>
        <div
          className={`absolute bottom-1/4 left-1/5 text-3xl font-bold ${equationColors[2]} animate-equation-float-3`}
        >
          E = mc²
        </div>
        <div
          className={`absolute top-1/2 right-1/6 text-3xl font-bold ${equationColors[3]} animate-equation-float-4`}
        >
          a² + b² = c²
        </div>
        ...
        <div
          className={`absolute top-[85%] left-[45%] text-2xl font-bold ${equationColors[4]} floating-icon-slow`}
        >
          F = ma
        </div>
        <div
          className={`absolute bottom-[75%] right-[65%] text-2xl font-bold ${equationColors[5]} floating-icon-reverse`}
        >
          V = IR
        </div>
        <div
          className={`absolute top-[13%] left-[88%] text-3xl font-bold ${equationColors[0]} animate-equation-float-1`}
        >
          ∇²φ = ρ/ε₀
        </div>
        <div
          className={`absolute bottom-[13%] right-[88%] text-2xl font-bold ${equationColors[1]} animate-equation-float-2`}
        >
          ∂u/∂t = α∇²u
        </div>
        <div
          className={`absolute top-[67%] left-[13%] text-3xl font-bold ${equationColors[2]} animate-equation-float-3`}
        >
          |ψ⟩ = α|0⟩ + β|1⟩
        </div>
        <div
          className={`absolute bottom-[33%] right-[13%] text-2xl font-bold ${equationColors[3]} animate-equation-float-4`}
        >
          P(A|B) = P(B|A)P(A)/P(B)
        </div>
        <div
          className={`absolute top-[55%] left-[85%] text-2xl font-bold ${equationColors[4]} floating-icon-slow`}
        >
          λ = h/p
        </div>
        <div
          className={`absolute bottom-[55%] right-[85%] text-3xl font-bold ${equationColors[5]} floating-icon-reverse`}
        >
          ∮ F⃗·dl⃗ = 0
        </div>
        <div
          className={`absolute top-[43%] left-[65%] text-2xl font-bold ${equationColors[0]} animate-equation-float-1`}
        >
          S = k ln Ω
        </div>
        <div
          className={`absolute bottom-[43%] right-[65%] text-3xl font-bold ${equationColors[1]} animate-equation-float-2`}
        >
          H = -∑ pᵢ log pᵢ
        </div>
        <div
          className={`absolute top-[77%] left-[35%] text-2xl font-bold ${equationColors[2]} animate-equation-float-3`}
        >
          x = (-b ± √D)/2a
        </div>
        <div
          className={`absolute bottom-[77%] right-[35%] text-2xl font-bold ${equationColors[3]} floating-icon-slow`}
        >
          ∇ × B⃗ = μ₀J⃗
        </div>
        ...
        <div className="absolute top-[8%] left-[5%] opacity-35 floating-icon-slow">
          <svg
            ...
            className={`h-20 w-20 ${symbolColors[0]}`}
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
          >
        ...
        <div className="absolute top-[12%] left-[30%] opacity-30 floating-icon">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className={`h-18 w-18 ${symbolColors[1]}`}
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
          >
        ...
        <div className="absolute top-[10%] left-[55%] opacity-35 floating-icon-reverse">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className={`h-22 w-22 ${symbolColors[2]}`}
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
          >
        ...
        <div className="absolute top-[14%] left-[80%] opacity-30 floating-icon-slow">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className={`h-16 w-16 ${symbolColors[3]}`}
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
          >
        ...
        <div className="absolute top-[6%] right-[8%] opacity-35 floating-icon">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className={`h-24 w-24 ${symbolColors[4]}`}
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
          >
        ...
        <div className="absolute top-[28%] left-[8%] opacity-30 floating-icon-reverse">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className={`h-20 w-20 ${symbolColors[5]}`}
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
          >
        ...
        <div className="absolute top-[32%] left-[40%] opacity-35 floating-icon-slow">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className={`h-18 w-18 ${symbolColors[6]}`}
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
          >
        ...
        <div className="absolute top-[30%] right-[12%] opacity-30 floating-icon">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className={`h-22 w-22 ${symbolColors[7]}`}
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
          >
        ...
        <div className="absolute top-[48%] left-[3%] opacity-35 floating-icon-slow">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className={`h-16 w-16 ${symbolColors[8]}`}
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
          >
        ...
        <div className="absolute top-[52%] left-[25%] opacity-30 floating-icon-reverse">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className={`h-20 w-20 ${symbolColors[9]}`}
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
          >
        ...
        <div className="absolute top-[50%] left-[50%] opacity-35 floating-icon">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className={`h-18 w-18 ${symbolColors[10]}`}
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
          >
        ...
        <div className="absolute top-[46%] left-[75%] opacity-30 floating-icon-slow">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className={`h-24 w-24 ${symbolColors[11]}`}
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
          >
        ...
        <div className="absolute top-[54%] right-[5%] opacity-35 floating-icon-reverse">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className={`h-16 w-16 ${symbolColors[12]}`}
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
          >
        ...
        <div className="absolute top-[68%] left-[12%] opacity-30 floating-icon">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className={`h-22 w-22 ${symbolColors[13]}`}
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
          >
            <path
              ...
              strokeLinejoin="round"
              strokeWidth={1.5}
              d="M7 4V2a1 1 0 011-1h8a1 1 0 011 1v2m-9 0h10m-9 0v16a2 2 0 002 2h6a2 2 0 002-2V4m-6 4v4m0 4h.01"
            />
          </svg>
        </div>
        <div className="absolute top-[72%] left-[35%] opacity-35 floating-icon-slow">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className={`h-18 w-18 ${symbolColors[14]}`}
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
          >
        ...
        <div className="absolute top-[70%] left-[62%] opacity-30 floating-icon-reverse">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className={`h-20 w-20 ${symbolColors[15]}`}
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
          >
        ...
        <div className="absolute top-[66%] right-[15%] opacity-35 floating-icon">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className={`h-16 w-16 ${symbolColors[0]}`}
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
          >
        ...
        <div className="absolute top-[90%] left-[28%] opacity-35 floating-icon-reverse">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className={`h-20 w-20 ${symbolColors[2]}`}
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
          >
        ...
        <div className="absolute top-[92%] left-[76%] opacity-35 floating-icon-slow">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className={`h-22 w-22 ${symbolColors[4]}`}
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
          >
        ...
        <div className="absolute top-[84%] right-[8%] opacity-30 floating-icon-reverse">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className={`h-18 w-18 ${symbolColors[5]}`}
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
          >
